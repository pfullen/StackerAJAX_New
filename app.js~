...
var showAnswerers = function (answerers) {
	sAnswerer = JSON.stringify(answeres);
	alert(sAnswerer);
alert('This is the answerers data ' + answerers.users);
// clone our result template code
	var result2 = $('.templates .answerers').clone();
	
	
	var name = result2.find('.answerers-text');
...
var getAnswerers = function(url) {
	...
	.done(function(result2){
		...
		alert( "this is result 2" +result3);
